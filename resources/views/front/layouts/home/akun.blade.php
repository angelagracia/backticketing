            ...
            <div class="col-sm-12 col-md-8 col-lg-9">
              <div class="row page-content">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-50">
                    <div class="inner-box">
                      <div class="dashboard-box">
                        <h2 class="dashbord-title">Ubah Kata Sandi</h2>
                      </div>
                      <div class="dashboard-wrapper">
                          <label class="control-label">Password Lama</label>
                        <div class="form-group mb-3">
                          <input class="form-control input-md" name="password" placeholder="Masukkan Kata Sandi" type="text">
                        </div>
                          <label class="control-label">Password Baru</label>
                        <div class="form-group mb-3">
                          <input class="form-control input-md" name="password" placeholder="Masukkan password" type="password">
                        </div>
                        <label class="control-label">Konfirmasi Kata Sandi Baru</label>
                        <div class="form-group mb-3">
                          <input class="form-control input-md" name="password" placeholder="konfirmasi password" type="password">
                        </div>
